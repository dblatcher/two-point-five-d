...
import { brickWall, dinoSprite, duckSprite } from "./sprites";
...
const floor:Level = new Level({
    ...
    walls: [
        ...
        new Wall({ x: 3, y: 3, place: Direction.east, shape: lowWall, sprite: brickWall }),
        ...
        new Wall({ x: 3, y: 0, place: Direction.north, sprite:brickWall }),
        new Wall({ x: 4, y: 0, place: Direction.north, sprite:brickWall }),
        new Wall({ x: 5, y: 0, place: Direction.north, sprite:brickWall }),
        new Wall({ x: 6, y: 0, place: Direction.north, sprite:brickWall }),
        new Wall({ x: 7, y: 0, place: Direction.north }),
        new Wall({ x: 8, y: 0, place: Direction.north }),
        new Wall({ x: 9, y: 0, place: Direction.north }),
        new Wall({ x: 9, y: 0, place: Direction.east, sprite:brickWall }),
    ],
    contents: [
