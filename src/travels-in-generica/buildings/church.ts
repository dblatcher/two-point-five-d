...
function makeChurch(x: number, y: number): { walls: Wall[], ceilings: SquareWithFeatures[] } {
    ...
    return {
        walls: [
            new Wall({ x: x + 2, y: y + 2, place: Direction.south, features: [], shape: tower, patternSprite: sharedSprites.brickWall, }),
            ...
            new Wall({ x: x + 4, y: y + 3, place: Direction.north, shape: tower, features:[features.poemBoard], patternSprite: sharedSprites.brickWall, }),
